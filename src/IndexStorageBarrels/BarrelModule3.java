...
import RMISearchModule.SearchModule3_S_I;
import classes.Page;
...
public class BarrelModule3  extends UnicastRemoteObject implements BarrelModule3_S_I,Runnable {
    public static SearchModule3_S_I h;
    public static BarrelModule3 c;

    public BarrelModule3() throws RemoteException {
        super();
    }
    ...
    public void run() {
        ...
        try{
            ...
            h = (SearchModule3_S_I) LocateRegistry.getRegistry(7002).lookup("XPT");
            c = new BarrelModule3();
            h.subscribe("Storage Barrel", (BarrelModule3_S_I) c);
